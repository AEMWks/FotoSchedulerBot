...
class PhotoDiaryCommon {
    ...
    closeAllModals() {
        const modals = document.querySelectorAll('.modal-overlay, .lightbox, .slideshow-overlay');
    ...
    saveSettings(newSettings) {
        ...
        localStorage.setItem('photo-diary-settings', JSON.stringify(this.state.settings));
